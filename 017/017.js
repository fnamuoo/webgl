...
window.onload = () => {
  ...
  // 
  const moBox2Const = new CANNON.LockConstraint(moBox2ABody, moBox2BBody);
  moBox2Const.pivotA = new CANNON.Vec3(0, -1, 0);
  moBox2Const.pivotB = new CANNON.Vec3(0,  1, 0);
  ...
  //
  const moBox3Const = new CANNON.LockConstraint(moBox3ABody, moBox3BBody);
  moBox3Const.pivotA = new CANNON.Vec3(-1, 0, 0);
  moBox3Const.pivotB = new CANNON.Vec3( 1, 0, 0);
  ...
  //
  const moBox4Const = new CANNON.LockConstraint(moBox4ABody, moBox4BBody);
  moBox4Const.pivotA = new CANNON.Vec3(-3, 0, 0);
  moBox4Const.pivotB = new CANNON.Vec3( 0, 3, 0);
  ...
  const moBox5ABody = new CANNON.Body({ mass: 0, position: new CANNON.Vec3(30, 5, 0) })
  ...
  const moBox5BBody = new CANNON.Body({ mass: 1, position: new CANNON.Vec3(28, 5, 0) })
  ...
  //
  const moBox5Const = new CANNON.LockConstraint(moBox5ABody, moBox5BBody);
  moBox5Const.pivotA = new CANNON.Vec3(-1, 0, 0);
  moBox5Const.pivotB = new CANNON.Vec3( 1, 0, 0);
  world.addConstraint(moBox5Const);
  //
  moBox5BBody.applyImpulse(new CANNON.Vec3(0, 3e6, 0), new CANNON.Vec3(0, 0, 1));
