...
export var createScene_007 = async function () {
...
console.log("stageType=",stageType);
                ...
                if (stageType=='lineTrain') {
                    ...
                    // trainColor = BABYLON.Color3.White(); // for DEBUG
                    // trainSpd *= 0.1;
                    // trainPad = -0.0007; // 車両が重なっているケース
                    // trainPad = -0.0008;
                    // trainPad = -0.0010; // 車両が空きすぎているケース
                    ...
                    for (let iline = 0; iline < trainNs.length; ++iline) {
                        ...
                        for (let i = 0; i <= nMeshTrain; ++i) {
                            ...
                            if (i < nMeshTrain) {
                                ...
                                // mesh.material.wireframe = 1; // for DEBUG
                                mesh._path3d = path3d;
                                if (i == 0) {
...
export var createScene = createScene_007; // 複数ライン／カメラあれこれ カメラfix
