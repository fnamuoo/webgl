...
console.log("createStage istage=", istage);
        ...
        if (istage == 0) {
            ...
            let h=16.7;
            {
                ...
                // パイプの長さ
                let plist2 = [], z0 = -2, zstep=0.5, zn = 400, z;
                for (let i = 0; i < zn; ++i) {
                    z = z0 + i*zstep;
                    plist2.push(new BABYLON.Vector3( 0, 0, z));
                }
            ...
            let x = -2.5, y = h+1.5, z = 0;
            pStart = new BABYLON.Vector3(x, y, z);
            pStart2 = new BABYLON.Vector3(x+1, y, z-0.1);
        }
