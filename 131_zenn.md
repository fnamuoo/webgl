...
![](https://storage.googleapis.com/zenn-user-upload/02e247c53319-20260327.gif)
*プレイ画面１（２倍速）*

![](https://storage.googleapis.com/zenn-user-upload/cbcf79cce337-20260327.gif)
*プレイ画面２（２倍速）*
...
https://github.com/fnamuoo/webgl/blob/main/131
...
![](https://storage.googleapis.com/zenn-user-upload/d1199b1a22eb-20260327.jpg)
*ブロック*

![](https://storage.googleapis.com/zenn-user-upload/b04a2a8ac55b-20260327.jpg)
*壁*

![](https://storage.googleapis.com/zenn-user-upload/cff6052ff619-20260327.jpg)
*加速器*
...
2025年度の [マイクロマウス](https://www.ntf.or.jp/entry/2025/RobotEnt01.php) のサイトを訪問して、全日本および地区大会の迷路情報を見てデータを作成します。といってもテキストで地図を作成するだけです。
テキストデータから地図を作成するライブラリは既に [迷路作成モジュール（１）「通路と壁が同じサイズ」と「薄い壁」](https://zenn.dev/fnamuoo/articles/ebd8f752af9b11) で作成済みなので、下記のような感じで地図をおこすだけになります。
...
薄い壁の迷路づくりは [Babylon.js：合わせ鏡とミラーハウス](https://zenn.dev/fnamuoo/articles/7d7368132becab) をベースとします。鏡の効果は余分なので削除するとして、迷路を作成するルーチンや、スタート位置／ゴール位置のメッシュの配置などはそのまま流用します。

### ゲーム作り：ボールをポップ

ゲームの要となるボールの湧き出し（ポップ）は [Babylon.js で物理演算(havok)：門松／ししおどし](https://zenn.dev/fnamuoo/articles/38f4cafeaf7d96) でのルーチンを流用します。

::::details ボールのポップとポップ判定
```js
    // ボール
...
![](https://storage.googleapis.com/zenn-user-upload/7a690a2dfcf5-20260327.jpg)
*カーソル*

::::details カーソル表示切り替え処理
```js
