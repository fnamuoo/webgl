...
![](https://storage.googleapis.com/zenn-user-upload/5db607e0aebc-20251219.gif)
...
https://github.com/fnamuoo/webgl/blob/main/112
...
[Babylon.js で物理演算(havok)：extrudeのねじれたコースを走る](https://zenn.dev/fnamuoo/articles/6c51dd7b74fe9d)
...
カーブで外側に向くようなねじれ  
![](https://storage.googleapis.com/zenn-user-upload/611f50737929-20251219.jpg)

ねじれを部分的に修正したコース  
![](https://storage.googleapis.com/zenn-user-upload/f9eea0f4a2e9-20251219.jpg)
...
コース画像  
![](https://storage.googleapis.com/zenn-user-upload/71dabb0c655d-20251219.png)

を渡して、センターラインを描かせて、一定の間隔で点を配置まではできました！

「test_生成AI」  
![](https://storage.googleapis.com/zenn-user-upload/4861a149eb01-20251219.png)
...
抽出した点列でコースを作成した場合  
![](https://storage.googleapis.com/zenn-user-upload/387bef38eaa0-20251219.jpg)

別の生成ＡＩではまったく上手くいかないケースもあります。

生成ＡＩに点を打たせたところ（別の生成AIでの失敗例）  
![](https://storage.googleapis.com/zenn-user-upload/fc22f27bb694-20251219.png)
...
入力  
![](https://storage.googleapis.com/zenn-user-upload/00104c1e73db-20251219.png)

結果（部分的に抜粋）  
![](https://storage.googleapis.com/zenn-user-upload/f2cafdcf6ec7-20251219.jpg)
...
手作業で円を打った様子  
![](https://storage.googleapis.com/zenn-user-upload/aeab4929c29b-20251219.jpg)

ほどよく等間隔の目印ができたので、更にレイヤーを重ねてコースの中心部分に点を打っていきます。

点だけのレイヤー  
![](https://storage.googleapis.com/zenn-user-upload/af9cd26295f9-20251219.jpg)
...
作成した座標データを描画  
![](https://storage.googleapis.com/zenn-user-upload/4f3bc20e12db-20251219.jpg)
...
ボールが配置されたコース  
![](https://storage.googleapis.com/zenn-user-upload/09750afa80e5-20251219.jpg)
...
ラベル付きのコース  
![](https://storage.googleapis.com/zenn-user-upload/14bb56eae659-20251219.jpg)
...
第１コーナー（４倍速）  
![](https://storage.googleapis.com/zenn-user-upload/ecce15010435-20251219.gif)
...
extrude を使う場合、断面形状を指定します。この断面が原点で回転することを考えると、原点との位置関係が重要になりそうです。そこで、下記の場合を見てみます。
...
![](https://storage.googleapis.com/zenn-user-upload/c50daa26e879-20251219.jpg)
...
コーナーへの侵入付近で撮影  
![](https://storage.googleapis.com/zenn-user-upload/48428d83802f-20251219.jpg)

コース全体を上空から見た場合  
![](https://storage.googleapis.com/zenn-user-upload/91fc5834bc7e-20251219.jpg)
...
02:原点の上部に断面形状を作った場合  
![](https://storage.googleapis.com/zenn-user-upload/a46182617bd9-20251219.jpg)

この場合バンクの内側の下がり具合がより強調され、それ以上にコースが内側にスライドしています。

コーナーへの侵入付近で撮影(バンク強＋UP)  
![](https://storage.googleapis.com/zenn-user-upload/245b6c6b254c-20251219.jpg)

コース全体を上空から見た場合(バンク強＋UP)  
![](https://storage.googleapis.com/zenn-user-upload/3a2ce8e9e119-20251219.jpg)

より原点から離れた配置することで、水平方向によりズレてます。

コース全体を上空から見た場合(バンク強＋UPx2)  
![](https://storage.googleapis.com/zenn-user-upload/a78449ccde08-20251219.jpg)
...
03:原点の下部に断面形状を作った場合  
![](https://storage.googleapis.com/zenn-user-upload/c1fc5196b332-20251219.jpg)

この場合、バンクの外側の上がり具合がより強調され、それ以上にコースが外側にスライドしたかのようになります。


コーナーへの侵入付近で撮影(バンク強＋DOWN)  
![](https://storage.googleapis.com/zenn-user-upload/36d084dec409-20251219.jpg)

コース全体を上空から見た場合(バンク強＋DOWN)  
![](https://storage.googleapis.com/zenn-user-upload/e07fa1ec8561-20251219.jpg)

コース全体を上空から見た場合(バンク強＋DOWNx2)  
![](https://storage.googleapis.com/zenn-user-upload/1de0f84012ad-20251219.jpg)
...
![](https://storage.googleapis.com/zenn-user-upload/515a0e3cc835-20251219.jpg)

この場合、右カーブで内側（右端）が下がり、左カーブの場合に外側（右端）が上がります。回転軸が端によっている分、高さの変化が大きくなったように感じます。またこれら以上にセンターラインがズレてしまいます。

コーナーへの侵入付近で撮影(バンク強＋RIGHT)  
![](https://storage.googleapis.com/zenn-user-upload/3b63244469ec-20251219.jpg)

コース全体を上空から見た場合(バンク強＋RIGHT)  
![](https://storage.googleapis.com/zenn-user-upload/71de70e8de2d-20251219.jpg)


道路（断面の線分）の右端を原点に配置した場合は、バンクの付き方が対称になり、こちらでも同様にセンターラインがズレます。

コーナーへの侵入付近で撮影(バンク強＋LEFT)  
![](https://storage.googleapis.com/zenn-user-upload/4039c4c079c4-20251219.jpg)

コース全体を上空から見た場合(バンク強＋LEFT)  
![](https://storage.googleapis.com/zenn-user-upload/7b0fc2afa159-20251219.jpg)
...
結果、最初の「原点を通る形状」が一番無難ということがわかりました。当初の『形状の配置する位置を変えることで、より滑らかにできないか試行錯誤』は失敗ということになります。

正直「原点の下に配置」はなめらかにバンクできるかと期待していたのですがダメでした。バンクをつけるとコースが外にそれ、逆にバンクを戻すと内側に寄ります。結果、アウト・イン・アウトのラインを走ろうとするとコーナーの最後で壁が想定外にせまってきて激突します。
...
![](https://storage.googleapis.com/zenn-user-upload/b9ed4154511d-20251219.jpg)

「test_高低差（激）のみ」（全体像）  
![](https://storage.googleapis.com/zenn-user-upload/60b567f69175-20251219.jpg)

「test_高低差（ゆる）」（スタート付近からゴール付近を見たところ）  
![](https://storage.googleapis.com/zenn-user-upload/83cf572191c1-20251219.jpg)

「test_高低差（ゆる）」（全体像）  
![](https://storage.googleapis.com/zenn-user-upload/0b01c193c452-20251219.jpg)
...
![](https://storage.googleapis.com/zenn-user-upload/850f2c402ceb-20251219.jpg)

「test_高低差（ゆる）＋バンク調整」（全体像）  
![](https://storage.googleapis.com/zenn-user-upload/bdc682c7c26f-20251219.jpg)
...
「AutumnRing」（全体像）  
![](https://storage.googleapis.com/zenn-user-upload/ecd499a010be-20251219.jpg)
...
「✕*2」（スタート付近）  
![](https://storage.googleapis.com/zenn-user-upload/e361e252a751-20251219.jpg)
...
結局、緩い高低差なら一律でrotate（extrudeのrotateオプション）するのがコスパよくベストアンサーな気がします。局所的にバンクをつけるのは楽しいですが、試走してみると角度変化が凹凸になって車が跳ねるし、走りにくくなったと思うことが多々ありました。高低差が激しい場合は今回の方法でも対処できない難しいケースがあり、今後の課題です。正直「ribbonで曲面を作ればいけるかも」と思わなくもないですが、それはそれで曲面／座標の計算が大変そうです。
