...
window.onload = () => {
  ...
  var ampHigh = 5.0; var ampHighAdj = 0;
  ...
  for (let _ih = 0; _ih < nh; ++_ih) {
    ...
    for (let _iw = 0; _iw < nw; ++_iw) {
      ...
      var iniW = iw*demw_;
      var {matrix, momatrix, vzmax} =
            createDem(demw, demh, iniW, iniH, sinPeriodW, sinPeriodH, ampHigh, ampHighAdj);
    ...
    if (changeCurHW == 1) {
      ...
      for (let _ih = 0; _ih < nh; ++_ih) {
        ...
        for (let _iw = 0; _iw < nw; ++_iw) {
          var iw = (_iw - 1 + curw + ncurw) % ncurw;
          var iniW = iw*demw_;
          var {matrix, momatrix, vzmax} = createDem(demw, demh, iniW, iniH, sinPeriodW, sinPeriodH, ampHigh, ampHighAdj);
