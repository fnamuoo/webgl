...
var createScene = async function () {
...

    {
        ...
        var Multiply = new BABYLON.MultiplyBlock("Multiply");
        var Gradient = new BABYLON.GradientBlock("Gradient");
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(0, new BABYLON.Color3(0, 30/255, 0))); // 深緑
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(1, new BABYLON.Color3(0, 88/255, 45/255))); // 深緑
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(3, new BABYLON.Color3(0, 204/255, 169/255))); // 深緑
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(5, new BABYLON.Color3(0, 200/255, 204/255))); // エメラルドグリーン
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(7, new BABYLON.Color3(200/255, 195/255, 161/255))); //砂
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(10, new BABYLON.Color3(0.6, 0.5, 0.3)));
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(15, new BABYLON.Color3(0.4, 0.7, 0.3)));
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(20, new BABYLON.Color3(0.2, 0.5, 0.2)));
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(25, new BABYLON.Color3(0.4, 0.4, 0.3)));
        Gradient.colorSteps.push(new BABYLON.GradientBlockColorStep(29, new BABYLON.Color3(0.90, 0.90, 0.95)));
        // https://playground.babylonjs.com/?webgpu#Y2UGQ5#53
        var VectorSplitter = new BABYLON.VectorSplitterBlock("VectorSplitter");
        position.output.connectTo(VectorSplitter.xyzIn);
    ...
    var changeMat = function() {
        imat = (imat+1)%nmat;
        if ("waterMesh" in trgMeshInfo) {
            trgMeshInfo["waterMesh"].dispose();
            delete trgMeshInfo["waterMesh"];
        }
        mat = matlist[imat];
...
//        if (0){
	    ...
	    water.windForce = -10;
	    water.waveHeight = 0.1; // 1.7;
	    water.bumpHeight = 0; // 0.1;
	    water.windDirection = new BABYLON.Vector2(1, 1);
	    water.waterColor = new BABYLON.Color3(0, 0, 221 / 255);
	    water.colorBlendFactor = 0.5;
	    //water.addToRenderList(skybox);
	    waterMesh.material = water;
	    waterMesh.material.alpha = 0.2;
            trgMeshInfo["waterMesh"] = waterMesh;
        }
    }
