...
//  const viBaseGrid = new THREE.GridHelper(1000, 100, 0xff8888, 0xc0c0c0);
  ...
  if (1) {
    ...
    const dataInfo = [
        ...
        // ["gear_type1_h_free"     , x00+-6.5+40, y00+  0, z00+-40, 0],
        // ["gear_type1_h_act"      , x00+   0+40, y00+  0, z00+-40, 0, "red"],

        // ["gear_type3_h_free"     , x00+-10-20, y00+  0, z00+-45, 0],
        // ["gear_type3_h_act"      , x00+  0-20, y00+  0, z00+-45, 0, "red"],
        // ["gear_type3_v_free"     , x00+-15-20, y00+  5, z00+-45, 1, "blue"],
        // ["gear_type3_h_20_free"  , x00+-25-20, y00+ 10, z00+-45, 0],
        // ["gear_type3_v_free"     , x00+-35-20, y00+ 15, z00+-45, 1, "blue"],
        // ["gear_type3_h_40_free"  , x00+-15-20, y00+ 20, z00+-45, 0],

        // ["gear_type5_h_r_free"   , x00+-40-40, y00+ -5, z00+ -5+30, 0],
        // ["gear_type5_h_free"     , x00+-20-40, y00+  0, z00+ -5+30, 0],
        // ["gear_type5_h_act"      , x00+  0-40, y00+  0, z00+ -5+30, 0, "red"],

        // ["gear_type6_h_act"      , x00+  0+70, y00+  0, z00+ 25, 0, "#ffa0a0"],
        // ["gear_type6_h_free"     , x00+-10+70, y00+  0, z00+ 25, 0],
        // ["gear_type6_h_20_free"  , x00+-25+70, y00+  0, z00+ 25, 0],
        // ["gear_type6_h_40_free"  , x00+-55+70, y00+  0, z00+ 25, 0],
        // ["gear_type6_h_60_free"  , x00+  5+70, y00+  0, z00+ 60, 0],
