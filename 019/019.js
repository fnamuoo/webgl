...
// - 11_6_1
//   - ConeTwistConstraint : 点、扇の稼働＋ひねり
//                               - 挙動確認
// - 11_6_2
//   - ConeTwistConstraint : 点、扇の稼働＋ひねり
//                               - 関節
...
window.onload = () => {
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox2BBody = new CANNON.Body({ mass: 1, shape: moBox2BShape, position: new CANNON.Vec3(-2, 3, 10) })
  ...
  // 
  const moBox2Const = new CANNON.ConeTwistConstraint(moBox2ABody, moBox2BBody, {
    angle: Math.PI/3, // PI/3=60[degree] の2倍が 可動域（扇）
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
  ...
  moBox2BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  ...
  const moBox3BShape = new CANNON.Box(new CANNON.Vec3(1, 1, 1))
    // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox3BBody = new CANNON.Body({ mass: 1, shape: moBox3BShape, position: new CANNON.Vec3(8, 5, 10) })
  ...
  // 
  const moBox3Const = new CANNON.ConeTwistConstraint(moBox3ABody, moBox3BBody, {
    angle: Math.PI/6, // PI/6=30[degree] の2倍が可動域
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
  ...
  moBox3BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox4BBody = new CANNON.Body({ mass: 1, shape: moBox4BShape, position: new CANNON.Vec3(18, 5, 10) })
  ...
  // 
  const moBox4Const = new CANNON.ConeTwistConstraint(moBox4ABody, moBox4BBody, {
    angle: Math.PI/36, // PI/36=5[degree] の2倍が可動域
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
  ...
  moBox4BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox5BBody = new CANNON.Body({ mass: 1, shape: moBox5BShape, position: new CANNON.Vec3(-14, 5, 0) })
  ...
  // 
  const moBox5Const = new CANNON.ConeTwistConstraint(moBox5ABody, moBox5BBody, {
    angle: Math.PI/2, // PI/2=90[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
    twistAngle: Math.PI/6,  // PI/6=30[degree]
  });
  world.addConstraint(moBox5Const);
  moBox5BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox5Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox5Points = [];
  viBox5Points.push( moBox5ABody.position );
  viBox5Points.push( moBox5ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox6BBody = new CANNON.Body({ mass: 1, shape: moBox6BShape, position: new CANNON.Vec3(-4, 5, 0) })
  ...
  // 
  const moBox6Const = new CANNON.ConeTwistConstraint(moBox6ABody, moBox6BBody, {
    angle: Math.PI/3, // PI/3=60[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
  ...
  moBox6BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox6Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox6Points = [];
  viBox6Points.push( moBox6ABody.position );
  viBox6Points.push( moBox6ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox7BBody = new CANNON.Body({ mass: 1, shape: moBox7BShape, position: new CANNON.Vec3(6, 5, 0) })
  ...
  // 
  const moBox7Const = new CANNON.ConeTwistConstraint(moBox7ABody, moBox7BBody, {
    angle: Math.PI/6, // PI/6=30[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
  ...
  moBox7BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox7Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox7Points = [];
  viBox7Points.push( moBox7ABody.position );
  viBox7Points.push( moBox7ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox8BBody = new CANNON.Body({ mass: 1, shape: moBox8BShape, position: new CANNON.Vec3(16, 5, 0) })
  ...
  // 
  const moBox8Const = new CANNON.ConeTwistConstraint(moBox8ABody, moBox8BBody, {
    angle: Math.PI/36, // PI/36=5[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
  ...
  moBox8BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox8Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox8Points = [];
  viBox8Points.push( moBox8ABody.position );
  viBox8Points.push( moBox8ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox9BBody = new CANNON.Body({ mass: 1, shape: moBox9BShape, position: new CANNON.Vec3(-14, 5, -10) })
  ...
  // 
  const moBox9Const = new CANNON.ConeTwistConstraint(moBox9ABody, moBox9BBody, {
    angle: Math.PI/2, // PI/2=90[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
    pivotB: new CANNON.Vec3( 2, 0, 0),
    twistAngle: Math.PI/3,  // PI/3=60[degree]
  });
  world.addConstraint(moBox9Const);
  moBox9BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox9Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox9Points = [];
  viBox9Points.push( moBox9ABody.position );
  viBox9Points.push( moBox9ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox10BBody = new CANNON.Body({ mass: 1, shape: moBox10BShape, position: new CANNON.Vec3(-4, 5, -10) })
  ...
  // 
  const moBox10Const = new CANNON.ConeTwistConstraint(moBox10ABody, moBox10BBody, {
    angle: Math.PI/3, // PI/3=60[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
  ...
  moBox10BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox10Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox10Points = [];
  viBox10Points.push( moBox10ABody.position );
  viBox10Points.push( moBox10ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox11BBody = new CANNON.Body({ mass: 1, shape: moBox11BShape, position: new CANNON.Vec3(6, 5, -10) })
  ...
  // 
  const moBox11Const = new CANNON.ConeTwistConstraint(moBox11ABody, moBox11BBody, {
    angle: Math.PI/6, // PI/6=30[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
  ...
  moBox11BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox11Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox11Points = [];
  viBox11Points.push( moBox11ABody.position );
  viBox11Points.push( moBox11ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  // 適当な初期位置を与えても、制約に準じた位置に強制移動されるが、実装依存になる
  const moBox12BBody = new CANNON.Body({ mass: 1, shape: moBox12BShape, position: new CANNON.Vec3(16, 5, -10) })
  ...
  // 
  const moBox12Const = new CANNON.ConeTwistConstraint(moBox12ABody, moBox12BBody, {
    angle: Math.PI/36, // PI/36=5[degree]
    axisA: new CANNON.Vec3(1, 0, 0),  // bodyAから見た 回転軸
    axisB: new CANNON.Vec3(1, 0, 0),  // bodyB の回転軸（ローカル)
    pivotA: new CANNON.Vec3(-2, 0, 0),
  ...
  moBox12BBody.applyImpulse(new CANNON.Vec3(-1, 0, 0), new CANNON.Vec3( 0, 0, 1));
  //
  const viBox12Mtr = new THREE.LineBasicMaterial( { color: 0x0000ff } );
  const viBox12Points = [];
  viBox12Points.push( moBox12ABody.position );
  viBox12Points.push( moBox12ABody.position.vadd(new CANNON.Vec3(-2, 0, 0)) );
  ...
  function animate() {
    ...
    viBox5BMesh.position.copy(moBox5BBody.position);
    viBox5BMesh.quaternion.copy(moBox5BBody.quaternion);
    viBox5Points[1].copy(moBox5ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox5ABody.position));
    ...
    viBox6BMesh.position.copy(moBox6BBody.position);
    viBox6BMesh.quaternion.copy(moBox6BBody.quaternion);
    viBox6Points[1].copy(moBox6ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox6ABody.position));
    ...
    viBox7BMesh.position.copy(moBox7BBody.position);
    viBox7BMesh.quaternion.copy(moBox7BBody.quaternion);
    viBox7Points[1].copy(moBox7ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox7ABody.position));
    ...
    viBox8BMesh.position.copy(moBox8BBody.position);
    viBox8BMesh.quaternion.copy(moBox8BBody.quaternion);
    viBox8Points[1].copy(moBox8ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox8ABody.position));
    ...
    viBox9BMesh.position.copy(moBox9BBody.position);
    viBox9BMesh.quaternion.copy(moBox9BBody.quaternion);
    viBox9Points[1].copy(moBox9ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox9ABody.position));
    ...
    viBox10BMesh.position.copy(moBox10BBody.position);
    viBox10BMesh.quaternion.copy(moBox10BBody.quaternion);
    viBox10Points[1].copy(moBox10ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox10ABody.position));
    ...
    viBox11BMesh.position.copy(moBox11BBody.position);
    viBox11BMesh.quaternion.copy(moBox11BBody.quaternion);
    viBox11Points[1].copy(moBox11ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox11ABody.position));
    ...
    viBox12BMesh.position.copy(moBox12BBody.position);
    viBox12BMesh.quaternion.copy(moBox12BBody.quaternion);
    viBox12Points[1].copy(moBox12ABody.quaternion.vmult(new CANNON.Vec3(-2, 0, 0)).vadd(moBox12ABody.position));
