...
//const GoalTextPath = "textures/amiga.jpg";
// const charPathList = ["textures/pipo-charachip007.png",
//                       "textures/pipo-charachip008b.png",
//                      ];
// const skybox_path= "textures/TropicalSunnyDay";

const SCRIPT_URL1 = "../090/CourseData.js";
const GoalTextPath = "../078/textures/amiga.jpg";
...
var createScene = async function () {
    ...
    const metaStageInfo = {
        ...
        101001:{label:"KoukyoRunning",
                iy: 0.01, iystep: 0, scale: 0.1, adjx: -100-5, adjy: +1.5, adjz: +20, nz: 800, stageType:'extrude_plane', sW:5, cnsReachRadius:10, cnsRadius:3, cnsCollisionQueryRange:2, cnsSeparationWeight:100, debugMesh:1, cnsNAgent:10, cnsSpeedX:2, pQdbg:1, 
                dtype:"xz",
                data : CourseData.DATA.koukyoRunning_new.xz,
               },
        101002:{label:"KoukyoRunning",
                iy: 0.01, iystep: 0, scale: 0.1, adjx: -100-5, adjy: -10+3.2, adjz: +20, nz: 800, stageType:'ribbon', sW:4, guideH:1.8, cnsReachRadius:10, cnsRadius:3, cnsCollisionQueryRange:2, cnsSeparationWeight:100, debugMesh:1, cnsNAgent:10, cnsSpeedX:2, pQdbg:0, 
                dtype:"xzy",
                data : CourseData.DATA.koukyoRunning_new.xzy,
               },
    };
    ...
    // --------------------------------------------------
    if (1) {
        let files = ["./koukyo/dem.obj",
                     // "https://raw.githubusercontent.com/fnamuoo/webgl/main/092/koukyo/dem.obj",
                    ];
        for (let file of files) {
            ...
            BABYLON.ImportMeshAsync(file, scene).then((result) => {
                ...
                let s = 1.37;  // 1.31 ~ 1.4
                meshGeo.scaling = new BABYLON.Vector3(s, 10, s);
                meshGeo.position = new BABYLON.Vector3(100, -50, 100);
    ...
    var createStage = function(istage) {
        ...
        if (1) {
            ...
            if (metaStageInfo.stageType=='line') {
                // 補間した点群を線分で表示
                const mesh = BABYLON.MeshBuilder.CreateLines("arc", {points: plist2})
                mesh.color = BABYLON.Color3.Yellow();
            ...
            if (metaStageInfo.stageType=='ribbon') {
                ...
                }
                {
                    ...
                    meshGoal.material.diffuseTexture = new BABYLON.Texture(GoalTextPath, scene);
            ...
            let addAgent = function() {
                ...
                let transform = createKidMesh(itype);
    ...
    let characterGravity = new BABYLON.Vector3(0, -36, 0);
