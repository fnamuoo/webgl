...
![](https://storage.googleapis.com/zenn-user-upload/086a3e2831f9-20260227.gif)
*道路に合わせた地形*
...
https://github.com/fnamuoo/webgl/blob/main/126
...
以前の記事、[Babylon.js で物理演算(havok)：ボブスレー](https://zenn.dev/fnamuoo/articles/948254e2c146a8) や [Babylon.js で物理演算(havok)：ダウンヒルにバンクをつける](https://zenn.dev/fnamuoo/articles/7a24928baa4d55) ではコースだけを作成して宙ぶらりんな状態でした。
今回は、これらのコース／道路に合わせた凹凸形状を作成してみました。

かなり前 [Babylon.js の基礎調査：perlinノイズを使ってみる](https://zenn.dev/fnamuoo/articles/535eac8879957a) で、同じようなことはトライしてみましたが、今回はＡＩで定石を確認しつつ作ってみました。結果、スマートに開発でき、まぁまぁのモノができたと思います。

![](https://storage.googleapis.com/zenn-user-upload/3242797687ce-20260227.gif)
*まぁまぁのモノ*

## やりたいこと

３次元の座標値(x,y,z)のリストを持った線分があります。これをコースに見立てて [Extruding Shapes](https://doc.babylonjs.com/features/featuresDeepDive/mesh/creation/param/extrude_shape/) でコースのメッシュを作成します。
...
一応２つのＡＩに確認（下記添付）して裏をとりつつ、思わず「( ･∀･)=b ｸﾞｯｼﾞｮﾌﾞ」と、なってしまったのは内緒。数式の意味はよくわかりませんが、道路を制約条件として、凹凸を作ればよいのはわかりました。
...
![](https://storage.googleapis.com/zenn-user-upload/101d304b1b27-20260227.gif)
*制約データの高さのみ*
...
![](https://storage.googleapis.com/zenn-user-upload/3d33ab11d669-20260227.gif)
*平滑化100ループ*
...
![](https://storage.googleapis.com/zenn-user-upload/996f8098c6fd-20260227.gif)
*谷*

https://playground.babylonjs.com/?BabylonToolkit#A9IG1M#2

![](https://storage.googleapis.com/zenn-user-upload/d2d1f0778705-20260227.gif)
*尾根*
...
![](https://storage.googleapis.com/zenn-user-upload/eb1de975ed0a-20260227.gif)
*Ｘ軸正で下がる*

https://playground.babylonjs.com/?BabylonToolkit#A9IG1M#4

![](https://storage.googleapis.com/zenn-user-upload/1b871f21ff7c-20260227.gif)
*Ｘ軸正で上がる*
...
![](https://storage.googleapis.com/zenn-user-upload/2fb1e50c04bb-20260227.gif)
*均一な乱数*
...
![](https://storage.googleapis.com/zenn-user-upload/49555b2a2e42-20260227.gif)
*パーリンノイズ*
...
今回のコースはどれも折り返し（ヘアピン）があるので、「道路からの距離」による乱数の影響を控え目にしてます。一本道とかだったらもっと大きく変化をつけても良かったかもしれません。
造成にかかる時間がちょっと重いかなと思いますが、自動生成させてこれならまぁまぁの出来でしょうか？

道路にバンクがついているので、地形に対し道路を少し浮き上がらせています。あまり地形から上げ過ぎると浮いた感じになるので部分的に重なっているところがありますが目をつむってください。

ＡＩに設計を確認しておいて良かったです。おかげでスマートに開発が進みました。バグについても『下記コードについて考えられる不具合を指摘して』とすることで原因をいち早く見つけることができました。
