// 国土地理院、全国Q地図
// 富士山
// https://maps.qchizu.xyz/#12/35.362/138.732/&base=ort&ls=ort&disp=1&vs=c1g1j0h0k0l0u0t0z0r0s0m0f1&d=m
...
var createScene = async function () {
    ...
    var camera = new BABYLON.ArcRotateCamera("Camera", 0,0,0, new BABYLON.Vector3(0, 16, -30), scene);
    ...
    if (1) {
        let files = [
            //"./3d/mtFUJI/dem.obj",
            "https://raw.githubusercontent.com/fnamuoo/webgl/main/088/3d/mtFUJI/dem.obj",
        ];
    ...
    // for FUJI (５合目ふきん)
    let opt2 = {rngxmin:-140, rngxmax:-135, py:15, rngzmin:-130, rngzmax:150, emitRate:4000,
                life: 110, npart:4000000};
