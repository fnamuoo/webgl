...
- Crowd Navigation System(CNS) で 緊急避難シミュ
  - 学校・オフィス、ホールから一斉に避難経路へ

- Crowd Navigation System(CNS) で オリエンテーリング
  - 複数の箇所を順にめぐる
    - 目的地についたとき
      onReachTargetObservable
      https://doc.babylonjs.com/features/featuresDeepDive/crowdNavigation/crowdAgents/#agent-reaching-target-observer
