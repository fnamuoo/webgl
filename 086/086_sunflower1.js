...
const plantInfo = [
    {path:"textures/himawari.png", w:318, h:400, size:[[0.5, 0.7], [1.0, 1.4]]},
    {path:"textures/flower_lavender.png", w:645, h:722, size:[[0.2, 0.3], [0.3, 0.4]]},
    {path:"textures/flower_ayame.png", w:308, h:450, size:[[0.3, 0.4], [0.4, 0.6]]},
    {path:"textures/mugi.png", w:360, h:400, size:[[0.4, 0.5], [0.7, 1.1]]},
//    {path:"textures/plant_nekojarashi.png", w:387, h:400, size:[[0.4, 0.5], [0.7, 1.1]]},
];
