// 凹凸のある道路をキャラクターコントローラーでCNSと競争する(5)
...
var createScene = function () {
    ...
    let addAgent = function() {
        ...
        if (agentCubeList.length == 0) {
            ...
            agentParams.maxAcceleration = 2.0; agentParams.maxSpeed = 4.3;
        } else if (agentCubeList.length == 1) {
            agentCube.material.diffuseColor = BABYLON.Color3.Green();
            agentParams.maxAcceleration = 2.5; agentParams.maxSpeed = 4.1;
        } else {
