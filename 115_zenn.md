...
の移動モデル（RaycastVehicleや自作Raycast）に、アニメーションするメッシュを貼り付ける処理
...
を流用します。といってもbabylon.js のバージョンがちがっているのであちこち手をいれます。
...
- [Babylon.js：画像からコース作り（２／２）](https://zenn.dev/fnamuoo/articles/d1bb4441d1d35f)
