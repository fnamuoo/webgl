...
プレイ画面（４倍速）  
![](https://storage.googleapis.com/zenn-user-upload/87e5d4f319c4-20251107.gif)
...
公式のドキュメント[Detect the first mesh touched by the ray](https://doc.babylonjs.com/features/featuresDeepDive/mesh/interactions/picking_collisions#detect-the-first-mesh-touched-by-the-ray)にちょうどよいサンプル[Get First Mesh Hit By Ray](https://playground.babylonjs.com/#KNE0O#1327)があります。
...
パネルがバラバラな状態  
![](https://storage.googleapis.com/zenn-user-upload/03b67fc3c396-20251107.jpg)

パネルがつながった状態（枠が消える）  
![](https://storage.googleapis.com/zenn-user-upload/313a7d3d3bc0-20251107.jpg)

このためには、パネルを格子状に配置する位置に合わせて、メッシュを配列に持たせます。
またメッシュの格子位置(x,y)を記録しておきます。

::::details つながったパネルの枠を消す処理
```js
//隣を確認して、隣接していたら枠を消す
...
複数のパネルをまとめて動かす様子  
![](https://storage.googleapis.com/zenn-user-upload/eb5333ddcb2d-20251107.gif)
...
トロフィーパネル  
![](https://storage.googleapis.com/zenn-user-upload/e4ac3aa7bd03-20251107.jpg)
