...
平面なコース場  
![](105/pic/105_ss_21.jpg)

凹凸のあるコース場  
![](105/pic/105_ss_22.jpg)

一方で、車の違いを感じられるようにしました。キー（m）で切り替わります。
比較対象にオリジナルの車と今回カスタマイズした車を用意してます。

オリジナルの車  
![](105/pic/105_ss_31.jpg)

カスタマイズした車  
![](105/pic/105_ss_32.jpg)
...
前の記事：[babylonjs 環境を updateする](104.md)

次の記事：[Babylon.js で物理演算(havok)：移動体とカメラ](106.md)
