...
//    let x1 = -850, y1 = 0, z1 = -650;
//    let x1 = -1150, y1 = 0, z1 = -450;
    let x1 = -790, y1 = 0, z1 = +40;
//    let x1 = 0, y1 = 0, z1 = 0;
    let ppad = 30; // pole padding
    let ppad2 = 22; // pole padding
    const dataInfo = [["rail_st_slopeH20L20"    ,x1 +860 ,y1+ 110,z1  -60, 0],
                      ...
                      ["rail_st100"             ,x1 -400 ,y1+   0,z1  -60, 0],
                      ["rail_st100"             ,x1 -500 ,y1+   0,z1  -60, 0],
                      ["pole_02_h60"            ,x1 +850 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +850 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +800 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +800 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +750 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +750 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +700 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +700 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +650 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +650 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +600 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +600 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +550 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +550 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +500 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +500 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +450 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +450 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +400 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +400 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +350 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +350 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +300 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +300 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +250 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +250 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +200 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +200 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +150 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +150 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +100 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +100 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1  +50 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1  +50 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1   +0 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1   +0 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1  -50 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1  -50 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 -100 ,y1+   0,z1  -60-ppad, 0],
                      ...
                      ["pole_02_h60"            ,x1 -600 ,y1+   0,z1  -60, 0],
                      ["pole_02_h60"            ,x1 -550+10 ,y1+   0,z1  -10+10, 0],
                      ["pole_02_h60"            ,x1 -600-ppad ,y1+   0,z1  +40, 0],
                      ["pole_02_h60"            ,x1 -600+ppad ,y1+   0,z1  +40, 0],
                      ["pole_02_h60"            ,x1 -600-ppad ,y1+   0,z1  +90, 0],
                      ["pole_02_h60"            ,x1 -600+ppad ,y1+   0,z1  +90, 0],
                      ...
                      ["pole_02_h60"            ,x1 -590-ppad2 ,y1+   0,z1  +110+ppad2, 0],
                      // ["pole_02_h60"            ,x1 -590+ppad2 ,y1+   0,z1  +110-ppad2, 0],
                      ["pole_02_h60"            ,x1 -540-ppad2 ,y1+   0,z1  +160+ppad2, 0],
                      ["pole_02_h60"            ,x1 -540+ppad2 ,y1+   0,z1  +160-ppad2, 0],
                      ["pole_02_h60"            ,x1 -490-ppad2 ,y1+   0,z1  +210+ppad2, 0],
                      ["pole_02_h60"            ,x1 -490+ppad2 ,y1+   0,z1  +210-ppad2, 0],
                      ["pole_02_h60"            ,x1 -440-ppad2 ,y1+   0,z1  +260+ppad2, 0],
                      ["pole_02_h60"            ,x1 -440+ppad2 ,y1+   0,z1  +260-ppad2, 0],
                      ["pole_02_h60"            ,x1 -390-ppad2 ,y1+   0,z1  +310+ppad2, 0],
                      ["pole_02_h60"            ,x1 -390+ppad2 ,y1+   0,z1  +310-ppad2, 0],
                      ["pole_02_h60"            ,x1 -340-ppad2 ,y1+   0,z1  +360+ppad2, 0],
                      ["pole_02_h60"            ,x1 -340+ppad2 ,y1+   0,z1  +360-ppad2, 0],
                      ["pole_02_h60"            ,x1 -290-ppad2 ,y1+   0,z1  +410+ppad2, 0],
                      ["pole_02_h60"            ,x1 -290+ppad2 ,y1+   0,z1  +410-ppad2, 0],
                      ["rail_st_R45_2"          ,x1 -290 ,y1+   0,z1 +410, 1],
                      ["rail_arc_R45_r"         ,x1 -280 ,y1+   0,z1 +410, 2],
                      ["rail_st50"              ,x1 -260 ,y1+   0,z1 +420, 0],
                      ["pole_02_h60"            ,x1 -260 ,y1+   0,z1 +420+ppad, 0],
                      ["pole_02_h60"            ,x1 -210 ,y1+   0,z1 +420+ppad, 0],
                      ...
                      ["pole_02_h60"            ,x1 -190-ppad2 ,y1+   0,z1  +410-ppad2, 0],
                      ["pole_02_h60"            ,x1 -190+ppad2 ,y1+   0,z1  +410+ppad2, 0],
                      ["pole_02_h60"            ,x1 -140-ppad2 ,y1+   0,z1  +360-ppad2, 0],
                      ["pole_02_h60"            ,x1 -140+ppad2 ,y1+   0,z1  +360+ppad2, 0],
                      ["pole_02_h60"            ,x1  -90-ppad2 ,y1+   0,z1  +310-ppad2, 0],
                      ["pole_02_h60"            ,x1  -90+ppad2 ,y1+   0,z1  +310+ppad2, 0],
                      ["pole_02_h60"            ,x1  -40-ppad2 ,y1+   0,z1  +260-ppad2, 0],
                      ["pole_02_h60"            ,x1  -40+ppad2 ,y1+   0,z1  +260+ppad2, 0],
                      ["pole_02_h60"            ,x1  +10-ppad2 ,y1+   0,z1  +210-ppad2, 0],
                      ["pole_02_h60"            ,x1  +10+ppad2 ,y1+   0,z1  +210+ppad2, 0],
                      ["pole_02_h60"            ,x1  +60-ppad2 ,y1+   0,z1  +160-ppad2, 0],
                      ["pole_02_h60"            ,x1  +60+ppad2 ,y1+   0,z1  +160+ppad2, 0],
                      ["pole_02_h60"            ,x1 +110-ppad2 ,y1+   0,z1  +110-ppad2, 0],
                      // ["pole_02_h60"            ,x1 +110+ppad2 ,y1+   0,z1  +110+ppad2, 0],
                      ["rail_arc_R45"           ,x1 +110 ,y1+   0,z1 +100, 0],
                      ["rail_st100"             ,x1 +130 ,y1+   0,z1 +100, 0],
                      ["rail_st100"             ,x1 +230 ,y1+   0,z1 +100, 0],
                      ["pole_02_h60"            ,x1 +130 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +130 ,y1+   0,z1 +100+ppad, 0],
                      ["pole_02_h60"            ,x1 +180 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +180 ,y1+   0,z1 +100+ppad, 0],
                      ["pole_02_h60"            ,x1 +230 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +230 ,y1+   0,z1 +100+ppad, 0],
                      ["pole_02_h60"            ,x1 +280 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +280 ,y1+   0,z1 +100+ppad, 0],
                      ["pole_02_h60"            ,x1 +330 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +330 ,y1+   0,z1 +100+ppad, 0],
                      ["pole_02_h60"            ,x1 +380 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +430 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +480 ,y1+   0,z1 +100-ppad, 0],
                      ["pole_02_h60"            ,x1 +530 ,y1+   0,z1 +150-ppad, 0],
                      // ["pole_02_h60"            ,x1 +580 ,y1+   0,z1 +200-ppad, 0],
                      // ["pole_02_h60"            ,x1 +370-ppad ,y1+   0,z1 +150, 0],
                      ["pole_02_h60"            ,x1 +420-ppad ,y1+   0,z1 +200, 0],
                      ["pole_02_h60"            ,x1 +470-ppad ,y1+   0,z1 +250, 0],
                      ["rail_arc200"            ,x1 +330 ,y1+   0,z1 +100, 1],  // *＼
                      ["rail_st100"             ,x1 +520 ,y1+   0,z1 +300, 1],
                      ["pole_02_h60"            ,x1 +520+ppad ,y1+   0,z1 +150, 0],
                      ["pole_02_h60"            ,x1 +520+ppad ,y1+   0,z1 +200, 0],
                      ["pole_02_h60"            ,x1 +520+ppad ,y1+   0,z1 +250, 0],
                      ["pole_02_h60"            ,x1 +520-ppad ,y1+   0,z1 +300, 0],
                      ["pole_02_h60"            ,x1 +520+ppad ,y1+   0,z1 +300, 0],
                      ["pole_02_h60"            ,x1 +520-ppad ,y1+   0,z1 +350, 0],
                      ["pole_02_h60"            ,x1 +520+ppad ,y1+   0,z1 +350, 0],
                      ["pole_02_h60"            ,x1 +520-ppad ,y1+   0,z1 +400, 0],
                      ["pole_02_h60"            ,x1 +520+ppad ,y1+   0,z1 +400, 0],
                      ["rail_arc300"            ,x1 +520 ,y1+   0,z1 +400, 3],  // ＼*
                      ["pole_02_h60"            ,x1 +520-ppad ,y1+   0,z1 +450, 0],
                      ["pole_02_h60"            ,x1 +520-ppad ,y1+   0,z1 +500, 0],
                      ["pole_02_h60"            ,x1 +520-ppad ,y1+   0,z1 +550, 0],
                      ["pole_02_h60"            ,x1 +570-ppad ,y1+   0,z1 +600, 0],
                      ["pole_02_h60"            ,x1 +620-ppad ,y1+   0,z1 +650, 0],
                      ["pole_02_h60"            ,x1 +670-ppad ,y1+   0,z1 +700, 0],
                      ["pole_02_h60"            ,x1 +720-ppad ,y1+   0,z1 +750, 0],
                      ["pole_02_h60"            ,x1 +520+ppad ,y1+   0,z1 +450, 0],
                      ["pole_02_h60"            ,x1 +570+ppad ,y1+   0,z1 +500, 0],
                      ["pole_02_h60"            ,x1 +620+ppad ,y1+   0,z1 +550, 0],
                      ["pole_02_h60"            ,x1 +670+ppad ,y1+   0,z1 +600, 0],
                      ["pole_02_h60"            ,x1 +720+ppad ,y1+   0,z1 +650, 0],
                      ["pole_02_h60"            ,x1 +770-ppad ,y1+   0,z1 +750, 0],
                      ["pole_02_h60"            ,x1 +820-ppad ,y1+   0,z1 +750, 0],
                      ["pole_02_h60"            ,x1 +870-ppad ,y1+   0,z1 +750, 0],
                      ["pole_02_h60"            ,x1 +920-ppad ,y1+   0,z1 +750, 0],
                      ["pole_02_h60"            ,x1 +770+ppad ,y1+   0,z1 +650, 0],
                      ["pole_02_h60"            ,x1 +820+ppad ,y1+   0,z1 +650, 0],
                      ["pole_02_h60"            ,x1 +870+ppad ,y1+   0,z1 +600, 0],
                      ["rail_arc300"            ,x1 +820 ,y1+   0,z1 +400, 0],  // *／
                      ["pole_02_h60"            ,x1 +970-ppad ,y1+   0,z1 +750, 0],
                      ["pole_02_h60"            ,x1+1020-ppad ,y1+   0,z1 +700, 0],
                      ["pole_02_h60"            ,x1+1070-ppad ,y1+   0,z1 +650, 0],
                      ["pole_02_h60"            ,x1+1120-ppad ,y1+   0,z1 +600, 0],
                      // ["pole_02_h60"            ,x1+1170-ppad ,y1+   0,z1 +550, 0],
                      // ["pole_02_h60"            ,x1+1200-ppad ,y1+   0,z1 +500, 0],
                      ["pole_02_h60"            ,x1 +920+ppad ,y1+   0,z1 +550, 0],
                      ["pole_02_h60"            ,x1 +970+ppad ,y1+   0,z1 +500, 0],
                      ["pole_02_h60"            ,x1+1020+ppad ,y1+   0,z1 +450, 0],
                      ["rail_st100"             ,x1+1110 ,y1+   0,z1 +240, 1],
                      ["rail_st50"              ,x1+1110 ,y1+   0,z1 +340, 1],
                      ["rail_st"                ,x1+1110 ,y1+   0,z1 +390, 1],
                      ["pole_02_h60"            ,x1+1110-ppad ,y1+   0,z1 +240, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +240, 0],
                      ["pole_02_h60"            ,x1+1110-ppad ,y1+   0,z1 +290, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +290, 0],
                      ["pole_02_h60"            ,x1+1110-ppad ,y1+   0,z1 +340, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +340, 0],
                      ["pole_02_h60"            ,x1+1110-ppad ,y1+   0,z1 +390, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +390, 0],
                      // ["pole_02_h60"            ,x1+1110-ppad ,y1+   0,z1 +440, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +440, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +490, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +540, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +190, 0],
                      ["pole_02_h60"            ,x1+1110+ppad ,y1+   0,z1 +140, 0],
                      ["pole_02_h60"            ,x1+1110+ppad2 ,y1+  0,z1 +90-ppad2, 0],
                      ["pole_02_h60"            ,x1+1060+ppad2 ,y1+  0,z1 +40-ppad2, 0],
                      ["pole_02_h60"            ,x1+1010+ppad2 ,y1+  0,z1 -10-ppad2, 0],
                      ["pole_02_h60"            ,x1 +960+ppad2 ,y1+  0,z1 -60-ppad2, 0],
                      ["rail_arc300"            ,x1 +820 ,y1+   0,z1  -60, 1],  // *＼
                      ["pole_02_h60"            ,x1 +850 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +850 ,y1+   0,z1  -60+ppad, 0],
                      ["pole_02_h60"            ,x1 +900 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +950 ,y1+   0,z1  -60-ppad, 0],
                      ["pole_02_h60"            ,x1 +900+ppad2 ,y1+   0,z1  -10+ppad2, 0],
                      ["pole_02_h60"            ,x1 +950+ppad2 ,y1+   0,z1  +40+ppad2, 0],
                      ["pole_02_h60"            ,x1+1000+ppad2 ,y1+   0,z1  +90+ppad2, 0],
                      ["pole_02_h60"            ,x1+1030+ppad2 ,y1+   0,z1 +140+ppad2, 0],
    ...
    const src1  = new ST.Source_00(x1 +870,y1+ 140,z1   -60, 3, 0.02, 2);
    new ST.Accelerator_01(x1 +800,y1+   8,z1   -55,   -1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +780,y1+   8,z1   -55,   -1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +760,y1+   8,z1   -55,   -1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +740,y1+   8,z1   -55,   -1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +720,y1+   8,z1   -55,   -1, 0  , 0,  30);
