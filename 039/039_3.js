...
//    let x1 = 200, y1 = 0, z1 = +400;
//    let x1 = 500, y1 = 0, z1 = -200;
//    let x1 = 300, y1 = 0, z1 = -300;
//    let x1 = -100, y1 = 0, z1 = -30;
//    let x1 = -600, y1 = 0, z1 = -30;
//    let x1 = -900, y1 = 0, z1 = -330;
//    let x1 = -1200, y1 = 0, z1 = -630;
//    let x1 = -1500, y1 = 0, z1 = -330;
//    let x1 = -1200, y1 = 0, z1 = +600;
//    let x1 = -1500, y1 = 0, z1 = +300;
//    let x1 = -900, y1 = 0, z1 = +400;
    let x1 = -560, y1 = 0, z1 = 40;
    ...
    const dataInfo = [["rail_st_slopeH20L20"    ,x1 +610 ,y1+ 110,z1  -60, 0],
                      ...
                      ["rail_arc200"            ,x1 -100 ,y1+   0,z1 -250, 3],  // ＼*
                      ["rail_st50"              ,x1 -100 ,y1+   0,z1 -300, 1],
                      ["rail_arc200"            ,x1 -290 ,y1+   0,z1 -500, 1],  // *＼
                      ["rail_arc200"            ,x1 -490 ,y1+   0,z1 -500, 2],  // ／*
                      ["rail_st100"             ,x1 -490 ,y1+   0,z1 -300, 1],
                      ["rail_st100"             ,x1 -490 ,y1+   0,z1 -200, 1],
                      ["rail_st100"             ,x1 -490 ,y1+   0,z1 -100, 1],
                      ["rail_st100"             ,x1 -490 ,y1+   0,z1 +  0, 1],
                      ["rail_st100"             ,x1 -490 ,y1+   0,z1 +100, 1],
                      ["rail_arc200"            ,x1 -490 ,y1+   0,z1 +200, 3],  // ＼*
                      ["rail_arc200"            ,x1 -290 ,y1+   0,z1 +200, 0],  // *／
                      ["rail_arc200"            ,x1 -100 ,y1+   0,z1   +0, 2],  // ／*
                      ["rail_st100"             ,x1 +100 ,y1+   0,z1 +  0, 0],
                      ["rail_st100"             ,x1 +200 ,y1+   0,z1 +  0, 0],
                      ["rail_st100"             ,x1 +300 ,y1+   0,z1 +  0, 0],
                      ["rail_st100"             ,x1 +400 ,y1+   0,z1 +  0, 0],
                      ["rail_st100"             ,x1 +500 ,y1+   0,z1 +  0, 0],
                      ["rail_arc300"            ,x1 +600 ,y1+   0,z1 +  0, 1],  // *＼
                      ["rail_arc300"            ,x1 +890 ,y1+   0,z1 +300, 3],  // ＼*
                      ["rail_arc300"            ,x1+1190 ,y1+   0,z1 +300, 0],  // *／
                      ["rail_st100"             ,x1+1480 ,y1+   0,z1 +200, 1],
                      ["rail_st100"             ,x1+1480 ,y1+   0,z1 +100, 1],
                      ["rail_st100"             ,x1+1480 ,y1+   0,z1 +  0, 1],
                      ["rail_st100"             ,x1+1480 ,y1+   0,z1 -100, 1],
                      ["rail_st100"             ,x1+1480 ,y1+   0,z1 -200, 1],
                      ["rail_st100"             ,x1+1480 ,y1+   0,z1 -300, 1],
                      ["rail_st50"              ,x1+1480 ,y1+   0,z1 -350, 1],
                      ["rail_arc300"            ,x1+1190 ,y1+   0,z1 -650, 1],  // *＼
                      ["rail_arc300"            ,x1 +890 ,y1+   0,z1 -650, 2],  // ／*
                      ["rail_arc300"            ,x1 +600 ,y1+   0,z1 -350, 0],  // *／
                     ];
    ...
    new ST.Accelerator_01(x1 +480,y1+   8,z1   -55,   -1, 0  , 0,  30);
    new ST.Deccelerator_00(x1+80,y1+   8,z1   -55,   0.8);
    new ST.Deccelerator_00(x1+100,y1+   8,z1   -55,   0.8);
    new ST.Deccelerator_00(x1+120,y1+   8,z1   -55,   0.8);
    new ST.Accelerator_01(x1  -95,y1+   8,z1  -290,    0, 0  ,-1,  30);
    new ST.Accelerator_01(x1 -151,y1+   8,z1  -436,   -1, 0  ,-1,  30);
    new ST.Accelerator_01(x1 -290,y1+   8,z1  -495,   -1, 0  , 0,  30);
    new ST.Accelerator_01(x1 -433,y1+   8,z1  -433,   -1, 0  , 1,  30);
    new ST.Accelerator_01(x1 -485,y1+   8,z1  -290,    0, 0  , 1,  30);
    new ST.Accelerator_01(x1 -485,y1+   8,z1  -270,    0, 0  , 1,  30);
    new ST.Deccelerator_00(x1-485,y1+   8,z1  +180,   0.8);
    new ST.Deccelerator_00(x1-485,y1+   8,z1  +200,   0.8);
    new ST.Accelerator_01(x1 -428,y1+   8,z1  +338,    1, 0  , 1,  30);
    new ST.Accelerator_01(x1 -290,y1+   8,z1  +395,    1, 0  , 0,  30);
    new ST.Accelerator_01(x1 -152,y1+   8,z1  +338,    1, 0  ,-1,  30);
    new ST.Accelerator_01(x1  -95,y1+   8,z1  +200,    0, 0  ,-1,  30);
    new ST.Accelerator_01(x1  -38,y1+   8,z1   +62,    1, 0  ,-1,  30);
    new ST.Accelerator_01(x1 +100,y1+   8,z1    +5,    1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +120,y1+   8,z1    +5,    1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +140,y1+   8,z1    +5,    1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +160,y1+   8,z1    +5,    1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +180,y1+   8,z1    +5,    1, 0  , 0,  30);
    new ST.Deccelerator_00(x1+560,y1+   8,z1    +5,   0.8);
    new ST.Deccelerator_00(x1+580,y1+   8,z1    +5,   0.8);
    new ST.Deccelerator_00(x1+600,y1+   8,z1    +5,   0.8);
    new ST.Accelerator_01(x1 +808,y1+   8,z1   +92,    1, 0  , 1,  30);
    new ST.Accelerator_01(x1 +895,y1+   8,z1  +300,    0, 0  , 1,  30);
    new ST.Accelerator_01(x1 +987,y1+   8,z1  +513,    1, 0  , 1,  30);
    new ST.Accelerator_01(x1+1200,y1+   8,z1  +595,    1, 0  , 0,  30);
    new ST.Accelerator_01(x1+1403,y1+   8,z1  +503,    1, 0  ,-1,  30);
    new ST.Accelerator_01(x1+1485,y1+   8,z1  +300,    0, 0  ,-1,  30);
    new ST.Accelerator_01(x1+1485,y1+   8,z1  +280,    0, 0  ,-1,  30);
    new ST.Accelerator_01(x1+1485,y1+   8,z1  +260,    0, 0  ,-1,  30);
    new ST.Accelerator_01(x1+1485,y1+   8,z1  +240,    0, 0  ,-1,  30);
    new ST.Accelerator_01(x1+1485,y1+   8,z1  +220,    0, 0  ,-1,  30);
    new ST.Deccelerator_00(x1+1485,y1+  8,z1  -330,   0.8);
    new ST.Deccelerator_00(x1+1485,y1+  8,z1  -350,   0.8);
    new ST.Accelerator_01(x1+1403,y1+   8,z1  -553,   -1, 0  ,-1,  30);
    new ST.Accelerator_01(x1+1200,y1+   8,z1  -645,   -1, 0  , 0,  30);
    new ST.Accelerator_01(x1 +981,y1+   8,z1  -558,   -1, 0  , 1,  30);
    new ST.Accelerator_01(x1 +900,y1+   8,z1  -350,    0, 0  , 1,  30);
    new ST.Accelerator_01(x1 +808,y1+   8,z1  -142,   -1, 0  , 1,  30);
    srclist = [src1];
  }
